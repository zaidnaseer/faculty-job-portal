                    ...
                    <div className="w-full md:w-1/3 bg-white rounded-xl shadow p-6 text-center">
                        ...
                        <div className="mt-6 text-left space-y-2 text-sm">
                            ...
                            <div className="flex items-center gap-2">
                                <Mail size={16} /> {hasText(resume.email) ? resume.email : "Email not added"}
                            </div>

                            <div className="flex items-center gap-2">
                                <Phone size={16} /> {hasText(resume.phone) ? resume.phone : "Phone not added"}
                            </div>

                            <div className="flex items-center gap-2">
                                <MapPin size={16} /> {hasText(resume.location) ? resume.location : "Location not added"}
                            </div>
                        ...
                        <div className="mt-6 text-left">
                            ...
                            <div className="flex flex-wrap gap-2">
                                ...
                                {Array.isArray(resume.skills) && resume.skills.length > 0 ? resume.skills.map((skill, index) => (
                                    <span
                                        key={index}
                    ...
                    <div className="flex-1 space-y-6">
                        ...
                        <div className="bg-white p-6 rounded-xl shadow">
                            ...
                            {isEditing ? (
                                ...
                                <p className="text-gray-700">{hasText(resume.summary) ? resume.summary : "No summary added yet."}</p>
                        ...
                        <div className="bg-white p-6 rounded-xl shadow">
                            ...
                            {Array.isArray(resume.education) && resume.education.length > 0 ? resume.education.map((edu, index) => (
                        ...
                        <div className="bg-white p-6 rounded-xl shadow">
                            ...
                            {Array.isArray(resume.experience) && resume.experience.length > 0 ? resume.experience.map((exp, index) => (
                        ...
                        <div className="bg-white p-6 rounded-xl shadow">
                            ...
                            {Array.isArray(resume.publications) && resume.publications.length > 0 ? resume.publications.map((pub, index) => (
